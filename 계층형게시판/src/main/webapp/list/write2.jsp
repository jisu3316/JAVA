...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  ...
  <body>
	  ...
	  <hr width="600" color="Maroon" size="2" noshade>
	    <font size="5" color="Navy"><b>답변달기</b></font>
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <form name="input" action="list.do?m=answer&seq=${param.seq}&ref=${param.ref}&step=${param.step}&depth=${param.depth}" method="post">
	  <!-------------------------------------------------------------->
...
<%int step=(Integer)request.getAttribute("step"); 
	System.out.println("write2.jsp: "+step);
	String answer="";
	if(step==1){
		answer="{Re}";
	}else{
...
%>
			  <input type="text" name="subject" size="60" value='<c:if test="${ not empty param.ref}"><%=answer%></c:if>' >
			</td>
		  </tr>
		  <tr>
